...
export type ResolversTypes = {
  DataTime: ResolverTypeWrapper<Mapper<Scalars["DataTime"]["output"]>>;
...
export type ResolversParentTypes = {
  DataTime: Mapper<Scalars["DataTime"]["output"]>;
...
export interface DataTimeScalarConfig
  extends GraphQLScalarTypeConfig<ResolversTypes["DataTime"], any> {
  name: "DataTime";
}
...
> = {
  createdAt?: Resolver<ResolversTypes["DataTime"], ParentType, ContextType>;
  description?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
